"""
AOC1621 Puzzle: Scrambled Letters and Hash
"""
#!/usr/bin/python2

# usage: AOC1621.py < AOC1621_input.txt
...
print "Answer Part 1: %s" % day21(passw, scramblist, False)
# part 2:
# reverse actions themselves
# apply list of actions in reverse order
print "Answer Part 2: %s" % day21('fbgdceah',scramblist[::-1], True)
