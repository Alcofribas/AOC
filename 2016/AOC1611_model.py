...
# based on: https://github.com/iamjackg/aoc2016/blob/master/a11/a11.py

# rank: 954/821

# ultimately the problem is a purely mathematical one which can be solved by feeding the
# initial state into the right equation

# usage: python AOC1611.py < AOC1611_input.txt > AOC1611_output.txt
